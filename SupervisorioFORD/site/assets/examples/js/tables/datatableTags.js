  ...
  (function($) {
    var EditableTable = {
      ...
      rowAdd: function() {
        ...
        data = this.datatable.row.add(['', '', '', '0', '0',  actions]);
        ...
        $row.children('td').each(function(i) {
          ...
          if ($this.hasClass('actions')) {
			...
			$this.html('<input type="text" id="' + i + '" class="form-control input-block" style="width: 100%;" value="' + data[i] + '"/>');
              ...
              $this.html('<input type="number" id="' + i + '" class="form-control input-block" style="width: 100%;" value="' + data[i] + '"/>');
            }
          }
        });
	...
	var link = '/ActionCadastroTags?action=' + action + '&id=' + idAction + '&epc=' + document.getElementById("0").value + '&nome=' + document.getElementById("1").value + '&codigo=' + document.getElementById("2").value + '&xi=' + document.getElementById("3").value + '&yi=' + document.getElementById("4").value;
	if(enviarDadosNoMSG(link)){
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionCadastroTags?action=delete&id=" + id;
		if(action == "delete") {
			if(enviarDados(link)) {
