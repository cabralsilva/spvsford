...
public class SupervisorioAGVSCadastroLogicaMesh implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.cadastroLogicaMesh};
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		if(!Login.login(req, resp, Login.tokenCadastroLogicaMesh)) {
		...
		tags.add(Keys.keyGerarTabelaCondicoesLogicaMesh, mt.methodGerarTabelaCondicoesLogicaMesh);
