...
public class SupervisorioAGVSInicioTurno implements Command {

	private ConvertPAGinHTML cph;
	private String[] files = { PathFilesPAG.inicioTurno };
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		if (!Login.login(req, resp, Login.tokenInicioTurno)) {
		...
		tags.add(Keys.keyGenerateDashboard, mt.methodGenerateDashboardOperadorTurno);
