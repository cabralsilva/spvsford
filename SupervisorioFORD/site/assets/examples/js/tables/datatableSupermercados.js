...
(function(document, window, $) {
  ...
  (function($) {
	...
	var link = '/ActionCadastroSupermercados?action=' + action + '&nomeOld=' + idAction + '&nome=' + document.getElementById("0").value + '&id=' + document.getElementById("1").value + '&produto=' + document.getElementById("2").value;
	if(enviarDadosNoMSG(link)){
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionCadastroSupermercados?action=delete&nome=" + id;
		if(action == "delete") {
			if(enviarDados(link)) {
