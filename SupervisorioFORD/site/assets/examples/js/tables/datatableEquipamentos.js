...
(function(document, window, $) {
  ...
  (function($) {
	...
	var link = '/ActionCadastroEquipamentos?action=' + action + '&nomeOld=' + idAction + '&nome=' + document.getElementById("0").value + '&tipo=' + document.getElementById("1").value + '&rota=' + document.getElementById("2").value + '&id=' + document.getElementById("3").value;
	if(enviarDadosNoMSG(link)){
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionCadastroEquipamentos?action=delete&nome=" + id;
		if(action == "delete") {
			if(enviarDados(link)) {
