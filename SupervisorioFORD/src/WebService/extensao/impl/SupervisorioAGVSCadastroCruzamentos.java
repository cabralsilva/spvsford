...
public class SupervisorioAGVSCadastroCruzamentos implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.cadastroCruzamentos};
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		if(!Login.login(req, resp, Login.tokenCadastroCruzamentos)) {
		...
		tags.add(Keys.keyGenerateDashboard, mt.methodGenerateDashboardCadastroCruzamentos);
		...
		tags.add(Keys.keyGerarTabelaCruzamentos, mt.methodGerarTableCruzamento);
