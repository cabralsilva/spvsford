...
public class SupervisorioAGVSLogUsuariosTable implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.logUsuariosTable};
	...
	private void Home(Request req, Response resp) {
		PrintStream out = resp.getPrintStream();
		out.println(cph.getHtml(PathFilesPAG.logUsuariosTable));
		out.flush();
	}
