...
public class SupervisorioAGVSParadas implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.paradas};
...
//		tags.add(Keys.keyGerarInputsTagsParada, mt.methodGenerateInputsTagsParada);
//		tags.add(Keys.keyGenerateUser, mt.methodGenerateNomeUsuario);
	...
	private void Home(Request req, Response resp) {
		PrintStream out = resp.getPrintStream();
		out.println(cph.getHtml(PathFilesPAG.paradas));
		out.flush();
	}
