  ...
  (function($) {
    var EditableTable = {
      ...
      rowEdit: function($row) {
        ...
        $row.children('td').each(function(i) {
          ...
          if ($this.hasClass('actions')) {
			...
			if(i == 0) { 
			  ...
			  $this.html('<select  id="selectCruzamento" class="form-control" data-plugin="select">' + rowCruzamentos() + '</select>');
              valueCruzamento = data[i];
			} else if(i == 2) {
			  $this.html('<select  id="selectTag" class="form-control" data-plugin="select">' + rowTags() + '</select>');	
              valueTag = data[i];
			} else if(i == 3) {
			  $this.html('<select  id="selectTipo" class="form-control" data-plugin="select">' + rowTipo() + '</select>');	
              valueTipo = data[i];
			} else {
              $this.html('<input type="text" id="' + i + '" class="form-control input-block" value="' + data[i] + '"/>');
            }
		...
		var element = document.getElementById('selectCruzamento');
		if(valueCruzamento != '')
			element.value = valueCruzamento;
	...
	var link = '/ActionCadastroTagsCruzamento?action=' + action + '&idOld=' + idAction + '&nome=' + document.getElementById("0").value + '&tipo=' + document.getElementById("selectTipo").value + '&epc=' + document.getElementById("selectTag").value + '&cruzamento=' + document.getElementById("selectCruzamento").value;
	if(enviarDados(link)){
        var _self = this,
          $actions,
          values = [];
        ...
        values = $row.find('td').map(function() {
          ...
          if ($this.hasClass('actions')) {
			...
			var e;
			if(i == 2) {
				e = document.getElementById("selectCruzamento");
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionCadastroTagsCruzamento?action=delete&id=" + id;
		if(action == "delete") {
			if(enviarDados(link)) {
