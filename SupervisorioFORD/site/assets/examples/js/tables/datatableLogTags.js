		...
		$.ajax({
			...
			success: function (e){
				...
				if(teste == "OK"){
					...
					tableCustom.destroy();
					$('#exampleTableSearch > tbody').html(msg);
					tableCustom = $('#exampleTableSearch').DataTable();
				}
				else 
				{
...
(function(document, window, $) {
  ...
  (function() {
    $(document).ready(function() {
      ...
      tableCustom = $('#exampleTableSearch').DataTable(options);
    });
  })();
  ...
  (function($) {
    var EditableTable = {
      ...
      rowAdd: function() {
        ...
        data = this.datatable.row.add(['-1', '', '', '',  actions]);
        ...
        $row
          ...
          .addClass('actions');;
        this.rowEdit($row);
        this.datatable.order([0, 'desc']).draw(); // always show fields
      },
      ...
      rowEdit: function($row) {
	    ...
	    if(i == 0) {
	      $this.css({'display': 'none'});
              $this.html('<input style="display:none" type="number" id="' + i + '" class="form-control input-block" value="' + data[i] + '" disabled/>');
            } else if(i == 0) {
              $this.html('<input type="number" id="' + i + '" class="form-control input-block" value="' + data[i] + '" disabled/>');
            } else {
	...
	location.href = '/SGV/Cadastro/Empresas?action=save' + '&id=' + document.getElementById("0").value + '&cpf=' + document.getElementById("1").value + "&nameE=" + document.getElementById("2").value + "&End=" + document.getElementById("3").value;
