		...
		var EditableTable = {
						...
						if (i == 0) {
							$this
									.html('<input type="number" id="'
											+ i
											+ '" class="form-control input-normal" style="width: 80px;" value="'
											+ data[i] + '"/>');
							idAction = data[i];
						} else if (i == 2) {
							$this
									.html('<select  id="selectStatus" class="form-control" style="width: 100%;" data-plugin="select">'
											+ rowStatusAgvs()
											+ '</select>');
							valueStatus = data[i];
						} else if (i == 3) {
							$this
									.html('<select  id="selectTipo" class="form-control" style="width: 100%;" data-plugin="select">'
											+ rowTipoAGVS()
											+ '</select>');
							valueTipo = data[i];
						} else if (i == 5) {
							$this.html('<input type="text" pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" required id="'
											+ i
							...
							$this
									.html('<input type="text" id="'
											+ i
											+ '" class="form-control input-block" style="width: 100%;" value="'
											+ data[i] + '"/>');
						}
			...
			rowSave : function($row) {
				...
				var link = '/ActionCadastroAGVS?action=' + action + '&idOld='
						+ idAction + '&id='
						+ document.getElementById("0").value + '&nome='
						+ document.getElementById("1").value + '&status='
			...
			rowRemove : function($row) {
				...
				var link = "/ActionCadastroAGVS?action=delete&id=" + id;
				if (action == "delete") {
					if (enviarDados(link)) {
