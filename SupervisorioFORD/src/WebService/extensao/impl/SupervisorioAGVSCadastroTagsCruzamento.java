...
public class SupervisorioAGVSCadastroTagsCruzamento implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.cadastroTagsCruzamentos};
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		if(!Login.login(req, resp, Login.tokenCadastroTagsCruzamentos)) {
		...
		tags.add(Keys.keyGenerateDashboard, mt.methodGenerateDashboardCadastroTagsCruzamento);
		tags.add(Keys.keyGenerateUser, mt.methodGenerateNomeUsuario);
		tags.add(Keys.keyGerarComboboxTags, mt.methodGerarComboboxTags);
		tags.add(Keys.keyGerarComboboxTipoTagsCruzamento, mt.methodGerarComboboxTiposTagsCruzamento);
		tags.add(Keys.keyGerarComboboxCruzamentos, mt.methodGerarComboboxCruzamento);
		tags.add(Keys.keyGerarTabelaTagsCruzamentos, mt.methodGerarTabelaTagsCruzamento);
