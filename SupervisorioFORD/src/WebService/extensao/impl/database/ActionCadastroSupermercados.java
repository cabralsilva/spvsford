...
public class ActionCadastroSupermercados implements CommandDB {
		...
		if (req.getGetParams().containsKey(TagsValues.paramAction)) {
			if (req.getGetParams().get(TagsValues.paramAction).equals(TagsValues.valueDeleteParamAction)) {
				if (req.getGetParams().containsKey(TagsValues.paramNome)) {
					if (ConfigProcess.bd().deleteSupermercados(req.getGetParams().get(TagsValues.paramNome))) {
						ConfigProcess.bd().insertLogUsuarios(System.currentTimeMillis(),
								req.getCookies().get(Login.strKeyName).getValue(),
								"Excluiu Supermercado " + req.getGetParams().get(TagsValues.paramNome),
								Login.strExcluir);
						html = "OK";
					}
				}
				...
				if (req.getGetParams().containsKey(TagsValues.paramID)) {
					if (req.getGetParams().containsKey(TagsValues.paramNome)) {
						if (req.getGetParams().containsKey(TagsValues.paramProduto)) {
							if (req.getGetParams().containsKey(TagsValues.paramNomeOld)) {
								if (req.getGetParams().get(TagsValues.paramAction)
									...
									if (ConfigProcess.bd().insertSupermercados(
											req.getGetParams().get(TagsValues.paramNome),
											req.getGetParams().get(TagsValues.paramProduto), System.currentTimeMillis(),
									...
									if (ConfigProcess.bd().updateSupermercados(
											req.getGetParams().get(TagsValues.paramNome),
											req.getGetParams().get(TagsValues.paramProduto),
											Integer.parseInt(req.getGetParams().get(TagsValues.paramID)),
											System.currentTimeMillis(),
											req.getGetParams().get(TagsValues.paramNomeOld))) {
										ConfigProcess.bd().insertLogUsuarios(System.currentTimeMillis(),
												req.getCookies().get(Login.strKeyName).getValue(),
												"Alterou Supermercado " + req.getGetParams().get(TagsValues.paramNome),
												Login.strAlterar);
										html = "OK";
									}
