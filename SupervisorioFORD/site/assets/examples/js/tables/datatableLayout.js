  ...
  (function($) {
    var EditableTable = {
      ...
      rowAdd: function() {
        ...
        data = this.datatable.row.add(['', '0', '0', '0', '0', '',  actions]);
      ...
      rowEdit: function($row) {
        ...
        $row.children('td').each(function(i) {
          ...
          if ($this.hasClass('actions')) {
			...
			if(i == 0) { 
			  $this.html('<input type="text" id="' + i + '" class="form-control input-block" style="width: 100%;" value="' + data[i] + '"/>');
              idAction = data[i];
			} else if(i == 5) {
			  $this.html('<select  id="selectCor" class="form-control" style="width: 100%;" data-plugin="select">' + rowCor() + '</select>');
              valueCor = data[i];
			} else {
              $this.html('<input type="text" id="' + i + '"  style="width: 100%;" class="form-control input-block" value="' + data[i] + '"/>');
            }
          }
        });
		var element = document.getElementById('selectCor');
		if(valueCor != '')
			element.value = valueCor;
	...
	var link = '/ActionCadastroLines?action=' + action + '&id=' + idAction + '&descricao=' + document.getElementById("0").value + '&xi=' + document.getElementById("1").value + '&yi=' + document.getElementById("2").value + '&xf=' + document.getElementById("3").value + '&yf=' + document.getElementById("4").value + '&cor=' + document.getElementById("selectCor").value;
	if(enviarDadosNoMSG(link)){
        var _self = this,
          $actions,
          values = [];
        ...
        values = $row.find('td').map(function() {
          ...
          if ($this.hasClass('actions')) {
			...
			var e;
			if(i == 6) {
				e = document.getElementById("selectCor");
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionCadastroLines?action=delete&id=" + id;
		if(action == "delete") {
			if(enviarDados(link)) {
