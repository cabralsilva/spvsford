...
public class SupervisorioAGVSRastreamento implements Command {

	private ConvertPAGinHTML cph;
	private String[] files = { PathFilesPAG.rastreamento };
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		if (!Login.login(req, resp, Login.tokenRastreamento)) {
		...
		tags.add(Keys.keyGenerateDashboard, mt.methodGenerateDashboardManutencaoRastremento);
