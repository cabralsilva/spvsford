  ...
  (function($) {
    var EditableTable = {
      ...
      rowEdit: function($row) {
        ...
        $row.children('td').each(function(i) {
          ...
          if ($this.hasClass('actions')) {
			...
			if(i == 0) { 
			  ...
			  $this.html('<select  id="selectTag1" class="form-control" data-plugin="select">' + rowTags() + '</select>');
              tg1 = data[i];
			} else {
		...
		var element = document.getElementById('selectTag1');
		if(tg1 != '') {
			var i;
	...
	var link = '/ActionCadastroTempoTags?action=' + action + '&idOld=' + idAction + '&nome=' + document.getElementById("0").value + '&epc=' + document.getElementById("selectTag1").value + '&tempo=' + document.getElementById("2").value;
	if(enviarDados(link)){
        var _self = this,
          $actions,
          values = [];
        ...
        values = $row.find('td').map(function() {
          ...
          if ($this.hasClass('actions')) {
			...
			var e;
			if(i == 2) {
				e = document.getElementById("selectTag1");
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionCadastroTempoTags?action=delete&id=" + id;
		if(action == "delete") {
			if(enviarDados(link)) {
