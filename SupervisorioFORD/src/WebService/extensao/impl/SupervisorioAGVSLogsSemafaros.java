...
public class SupervisorioAGVSLogsSemafaros implements Command {

	private ConvertPAGinHTML cph;
	private String[] files = { PathFilesPAG.logsSemafaros };
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		tags.add(Keys.keyGenerateDashboard, mt.methodGenerateDashboardLogsSemafaros);
