...
public class SupervisorioAGVSPedidos implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.pedidos};
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		tags.add(Keys.keyGenerateDashboard, mt.methodGenerateDashboardPedidos);
		...
		tags.add(Keys.keyGerarTabelaPedidos, mt.methodGerarTablePedidos);
