  ...
  (function($) {
    var EditableTable = {
      ...
      events: function() {
        ...
        this.$table
		  .on('click', 'a.finaliza-row', function(e) {
            e.preventDefault();
			action = "fim";
            var $row = $(this).closest('tr');
            bootbox.dialog({
              message: "Tem certeza de que deseja Finalizar este Pedido?",
      ...
      rowAdd: function() {
        ...
        actions = [
		  '<a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default finaliza-row" data-toggle="tooltip" data-original-title="Finalizar"><i class="icon wb-edit" aria-hidden="true"></i></a>',
	...
	if(enviarDados(link)){
      ...
      rowRemove: function($row) {
		...
		var link = "/ActionPedidos?action=" + action + "&id=" + id;
		if(action == "delete" || action == "fim") {
			if(enviarDados(link)) {
