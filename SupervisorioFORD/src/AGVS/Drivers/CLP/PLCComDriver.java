...
public class PLCComDriver {
	...
	public static String sendBit(String ip, int port, int db, int memory, int id, boolean itValue, String typeCLP) {
		BufferedReader input = new BufferedReader(new InputStreamReader(System.in));
		try {
			System.out.println("db" + db + "memory" + memory);
			// authentication.User("Luiz Henrique Sehnem");
